          ...
          <div className="flex my-8">
            <div className="w-[70%]">
              ...
              <p className="text-xl font-normal w-[90%] text-gray-200 text-justify mt-2">
                ...
                adipisci! Provident sunt atque eveniet praesentium perspiciatis
                dolorum fugit omnis odit. In soluta minima illum ipsam eius est
                voluptatum accusantium repellendus sed provident, illo voluptate
                inventore neque debitis perferendis veniam temporibus
                dignissimos, cum blanditiis explicabo molestias ad sapiente?
                Corrupti, in incidunt?
              </p>
            </div>
